...
// TODO: is_virus удалить + вся таблица файлов (625гб) не поместится в оперативку, подумать, куда ее можно вынести
...
// TODO: проблема алгоритма: пользователь меняет тариф => идет перерасчет шардов - плохо( 
...
// TODO: почему для аналитики был выбран ClickHouse, а не касандра?
