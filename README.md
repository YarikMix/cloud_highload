...
Два других датацентра можно разместить в **Санкт Петербурге** и в **Краснодарском крае**.
...
// TODO: Обоснование почему такое расположение датацентров (что делать людям из хабаровска?)
...
// TODO: Где расположить CDN и сколько их должно быть?


Скачивание будет производиться с CDN
