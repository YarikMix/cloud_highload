...
// TODO: Сделать древовидную структуру папок (отказаться от parent)
...
// shared и folder лучше вынести в in-memory бд
...
// TODO: По каким полям шардировать file (по юзерам мимо, по parent тоже мимо)
