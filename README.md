...
Допустим, что средний размер PNG картинки ~= 5 MiB
...
```RPS = DAU * (0.05 + 300 * 91% + 27 * 70 + 600 + 100 + 0.6 + 4) / 86400 = 2873.65 * DAU /86400 ~ 153_800```
...
| Загрузка на диск                  | 116_000  | 289_000     |
...
```Трафик в секунду = (2.7 + 16_000 + 32_000 + 32 + 216) * 5KiB + 116_000 * (20% * 30KiB + 9% * 700MiB + 71% * 5MiB) ~ 7 Tbit/sec```
...
| Трафик в секунду         | 9 Tbit/s    |
| Пиковый трафик с секунду | 22.5 Tbit/s |
| RPS                      | 153_800     |
| Пиковый RPS              | 384_500     |
