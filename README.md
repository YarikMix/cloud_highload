...
## 11. Список серверов <a name="11_part"></a>

Согласно пункту <a name="3_part">3. Глобальная балансировка нагрузки</a>, у нашего сервиса будет 6 ЦОДов, состав серверов каждого ЦОДа разумно взять одинаковым, так как нагрузка на каждый ЦОД также планировалась одинаковой. На каждый ЦОД была рассчитана пиковая нагрузка: 930 RPS.
...
| Сервис      | Пиковый RPS | CPU | RAM   | Disk (суммарно для всех 6 ЦОДов) |
|-------------|-------------|-----|-------|:--------------------------------:|
| API Gateway | 930         | 9   | 2 Гб  |                -                 | 
| Auth        | 140         | 3   | 1 Гб  |                -                 |
| User        | 1000        | 10  | 2 Гб  |                -                 |
| Folder      | 2100        | 21  | 4 Гб  |                -                 |
| File        | 1500        | 15  | 3 Гб  |                -                 |
| Redis       | 500         | 10  | 20 Гб |               1 Тб               |
| Tarantool   | 5000        | 50  | 60 Гб |              300 Tб              |
| Neo4j       | 4000        | 40  | 30 Гб |              400 Тб              |
| Mongo       | 3000        | 30  | 40 Гб |             1000 Тб              |
| S3          | 6000        | 70  | 70 Гб |             700 Птб              |
| ClickHouse  | 4000        | 40  | 10 Гб |              10 Тб               |
| Nginx       | 930         | 9   | 10 Гб |                -                 |
