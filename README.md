...
Шардировать будем по хэшу от id
...
* Дублирование оборудования и резервирование (N+1, 2N). Гарантирует, что при выходе из строя одного компонента есть запасной для непрерывной работы системы.
