...
// TODO: Какая таблица где лежит

// Отдельное поле file_url для s3

// Избегаем join'ов между shared и folder - Провести денормализацию

// Нагрузку на чтение на запись по каждой таблице (больше на чтение, больше на запись)
