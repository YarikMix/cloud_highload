...
```Трафик в секунду = (2.7 + 54 + 107 + 32 + 216) * 5KiB + 320 * (20% * 30KiB + 9% * 700MiB + 71% * 5MiB) = 436 * 5KiB + 320 * 68153KiB ~ 20 Gbit/sec ```

Скачивание будет производится с s3 так что посчитаем его отдельно.

```Скачивание в секунду = 640 * (20% * 30KiB + 9% * 700MiB + 71% * 5MiB) ~ 40 Gbit/sec ```

Остальной трафик:

// TODO: Расписать рассчет по каждой ручке
...
| Скачивание с диска                | 535 KiB  | 1.3 Mbit         |
...
| Трафик в секунду         | 60 Gbit/s  |
| Пиковый трафик с секунду | 150 Gbit/s |
| RPS                      | 5600       |
| Пиковый RPS              | 14000      |

// TODO: Прирост основных метри за год
